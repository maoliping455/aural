...
| --- | --- | --- | --- | --- |
| A-001 | 配置 release 机器 Developer ID signing 和 notarytool keychain profile | Done for 0.1.0 RC | Release | release 机器已确认有效 `Developer ID Application` identity；`Aural-0.1.0.dmg` submission `f1ea5ff4-5c8e-49a5-a0e1-0bde5c217048` 已 `Accepted`，staple、stapler validate 和 Gatekeeper 验证通过 |
