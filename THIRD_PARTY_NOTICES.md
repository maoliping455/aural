...
The Git repository does not include model weights. Release builds may bundle:

| Model | Purpose | Notes |
| --- | --- | --- |
| Qwen3-ASR-1.7B, 4-bit MLX conversion | Default local ASR model | Review the upstream model card and conversion license before release. |
